...
${amarillo}Ejemplo ${rojo}>>> ${blanco}Termux_Hacking ${rojo}(Sin Espacios)
...
${rojo}█═════════════════════════════════════█
${rojo}█ ${amarillo}[${rojo}4${amarillo}]${rojo} | ${cyan}Solo Audio (Sin Video)${rojo} | ${amarillo}mp3${rojo}  █
${rojo}└═════════════════════════════════════┘
...
AUDIO (SIN VIDEO) DESCARGADO CORRECTAMENTE
EN LA RUTA >>>${rojo} $Ruta ${cyan}
CON EL NOMBRE DE >>>${rojo} $Nombre.mp3
"${blanco}
esac
...
${rojo}┌══════════════┐
${rojo}█ ${amarillo}[${rojo}1${amarillo}]${rojo} |${cyan}   SI${rojo}   █
${rojo}█══════════════█
${rojo}█ ${amarillo}[${rojo}2${amarillo}]${rojo} |${cyan}   NO${rojo}   █
${rojo}└══════════════┘
...
EJECUTE EL COMANDO ${amarillo}>>> ${rojo}./YouTube.sh
"${blanco}
esac
